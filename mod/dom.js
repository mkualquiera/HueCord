...
console.log('%cHueCord!', 'color: #FF5200; -webkit-text-stroke: 2px black; font-size: 72px; font-weight: bold;');
...
stylesheet_path = path.join(process.env.injDir, 'style.css');


window.onload = () => {readFile(stylesheet_path).then(css => {
